...
namespace pryFollentiTP
{
    public class clsAccesoDatos
    {
        ...
        public void ConectarBD()
        {
            try
            {
                conexionBD = new OleDbConnection(@"Provider = Microsoft.ACE.OLEDB.12.0;" + "Data Source = ..\\..\\Resources\\BD\\EMPLEADO.accdb");
                conexionBD.Open();
            ...
            , string varCiudad, string varDirreccion, string varTelefono)
        {
            ...
            //Que tabla traigo
            comandoBD.CommandText = "DATOS_PERSONALES";
            ...
            objDataAdap.Fill(objDataSet, "DATOS_PERSONALES");
            // obtenemos una referencia a la tabla


            DataTable dt = objDataSet.Tables["DATOS_PERSONALES"];
            ...
            objDataAdap.Update(objDataSet, "DATOS_PERSONALES");
            conexionBD.Close();
        ...
        public void BuscarPorApellido(string Apellido, DataGridView grilla)
        {
            ...
            if (lectorBD.HasRows)
            {
                ...
                if (encontro == 0)
                {
                    ...
                    MessageBox.Show("Apellido " + Apellido + " no esta cargado en el sistema");
                    TraerDatos(grilla);
                }
            }
        }
        public void BuscarPorCiudad(string ciudad, DataGridView grilla)
        {
            ...
            if (lectorBD.HasRows)
            {
                ...
                if (encontro == 0)
                {
                    ...
                    MessageBox.Show("No se encontro ningun empleado cargado en la ciudad " + ciudad);
                    TraerDatos(grilla);
